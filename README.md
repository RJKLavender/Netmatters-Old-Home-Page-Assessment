...
PHP Setup
When you download the code from the branch PHP Website, It will not work without:
1. First you will need to set up a database in your local enviroment. You will need two tables one for the news section and one for the contact form.
...
3. Fill out the fields listed as follows DB_Host is your database's Host IP, DB_PORT is the port of your database, DB_NAME is the name of your database, DB_USER is the username of the user accessing the database and DB_PASS is the password assicated with the user.
